...
bool InputManager::PrePushKey(BYTE keyNumber) const
{
...
bool InputManager::IsKeyReleased(BYTE keyNumber) const
{
	// 前が0ではなくて、今回が0
	if (keyPre_[keyNumber] && !key_[keyNumber]) {
		return true;
...
bool InputManager::ExitKey(BYTE keyNumber) const
{
	// 前回が0ではなくて、今回が0
	if (keyPre_[keyNumber] && !key_[keyNumber]) {
		return true;
...
bool InputManager::PushMouse(int32_t keyNumber) const
{
...
bool InputManager::TriggerMouse(int32_t keyNumber) const
{
	// 前が0で、今回が0でなければトリガー
...
bool InputManager::ExitMouse(int32_t keyNumber) const
{
	// 前が0ではなくて、今回が0
	if (mousePre_.rgbButtons[keyNumber] && !mouse_.rgbButtons[keyNumber]) {
		return true;
...
bool InputManager::GetJoystickState(int32_t stickNo, DIJOYSTATE2& out) const
{
...
bool InputManager::GetJoystickStatePrevious(int32_t stickNo, DIJOYSTATE2& out) const
{
	if (stickNo >= 0 && stickNo < static_cast<int32_t>(devJoysticks_.size())) {
